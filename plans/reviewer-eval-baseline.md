...
in its post-incident review); sequencing amendment to that plan's
Deviation 2 — evaluation
...
- **Fixture secrecy policy (hard)**: ci-toolkit is public; the
  originating consumer repositories are private. Fixtures derived from
  private-repo
...
- `eval/fixtures/` — ten fixtures, five positives each paired with a
  ...
  - M4 synthetic: docstring contract false of unseen code (miss #4

...
adapt — never reference governance across repos.** The templates
distill a lived-in production governance practice and add the
lifecycle invariants (branch from verified `main`, never from
